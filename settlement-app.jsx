...
const styles = {
  ...
  roundCard: { background: "#F6F8FB", border: "1px solid #E3E6EC", padding: 14 },
  ...
  selectInput: { flex: 1, minWidth: 0, fontFamily: "inherit", fontSize: 13.5, color: "#1A1D29", background: "#FFFFFF", border: "1px solid #DDE1E8", padding: "8px 6px" },
  ...
  chip: { fontFamily: "inherit", fontSize: 12.5, padding: "6px 10px", border: "1px solid", cursor: "pointer", borderRadius: 2, transition: "background 0.12s, color 0.12s, border-color 0.12s" },
