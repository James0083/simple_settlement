...
export const styles = {
    ...
    personBlock: { display: "flex", flexDirection: "column", gap: 6 },
    ...
    accountToggleBtn: { flexShrink: 0, border: "none", background: "transparent", color: "#5C6178", fontSize: 11.5, fontWeight: 600, cursor: "pointer", textDecoration: "underline", padding: "0 2px", whiteSpace: "nowrap" },
    accountInput: { width: "100%", fontFamily: "inherit", fontSize: 13, color: "#1A1D29", background: "#F6F8FB", border: "1px solid #DDE1E8", borderRadius: 4, padding: "8px 10px" },
    ...
    txList: { listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 8 },
    txItem: {},
    ...
    txAccount: { fontSize: 11.5, color: "#8A8FA3", marginLeft: 21, marginTop: 2 },
